<script setup>
import jquery from '../AllPages/JqueryFun.vue'
</script>
...
<template>
    <div class="content-protect">
        <div class="content-menu">
            ...
            <nav>
                <ul>
                    <li><a class="active_protect" href="/Protect">Защита
                            контента</a></li>
                    <li><a class="jurnal-main" href="/Jurnual">Журналы угроз</a></li>
                    <li><a class="black-list" href="#">Черный список</a></li>
...
.search .icon_search {
    ...
    width: 38px;
    height: 38px;
    background: url(../../public/icons/Search.svg) no-repeat #6C5DD3 center center;
...
.HeadSetting a {
    padding: 18px 36.5px 18px 36.5px;
}

.HeadSetting a:first-child {
    color: #6C5DD3;
